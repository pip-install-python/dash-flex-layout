...
ACCENT = (76, 110, 245)      # #4c6ef5 — manifest theme_color (Mantine indigo)
TEXT = (245, 246, 247)
MUTED = (150, 158, 168)
...
def build_card(artwork: Path, brand: str, tagline: str, domain: str) -> Image.Image:
    ...
    # cropped first: icon exports often carry transparent margin, which
...
def main() -> int:
    ...
    ap.add_argument("--artwork", default="assets/favicon/favicon-512.png",
    ...
    ap.add_argument("--tagline",
                    default="IDE-style dockable, resizable and floatable "
                            "window panels for Plotly Dash.")
