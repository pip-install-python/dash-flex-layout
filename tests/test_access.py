...
# Two real pages on this site. GATED_PAGE is only ever gated by a test's own
# monkeypatched tier — nothing here ships non-public (the host is DARK), which
# is exactly the posture these tests must hold under.
GATED_PAGE = "/theming"
PUBLIC_PAGE = "/basic"
